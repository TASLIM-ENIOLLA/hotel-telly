                    ...
                    <CardContent className="px-0">
                      <p className="text-4xl text-center first-letter:uppsercase">
                        <span className="font-tertiary text-foreground">
                          ...
                          Sollicitudin pulvinar eu consectetur tortor. At consequat cursus convallis vestibulum proin eget. Sit iaculis nec sed nisl urna purus lectus eget accumsan lectus ultrices quam.
                          <Quote className="inline align-top mx-3 stroke-0 fill-muted-foreground" />
                        </span>
                      </p>
                    </CardContent>
