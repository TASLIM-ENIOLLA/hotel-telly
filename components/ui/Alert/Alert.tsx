    ...
    <section className="fixed bottom-0 py-10 w-full">
      <div className="container">
        <div className="max-w-[500px] mx-auto">
          <div className={`flex rounded-lg overflow-hidden shadow-lg items-center p-4 mb-4 text-${theme}-800 border-t-4 border-${theme}-300 bg-${theme}-50 dark:text-${theme}-400 dark:bg-gray-800 dark:border-${theme}-800`}>
