        ...
        <div className="container">
          <div className="space-y-10">
            <div className="max-w-[600px] mx-auto">
              <div className="text-3xl text-center font-semibold capitalize">
                welcome to hotel telly
              </div>
            </div>
            <div className="max-w-[650px] mx-auto">
              <div className="text-black text-center font-normal tracking-wider">
          ...
          <div className="py-20">
            <div className="container">
              <div className="space-y-7">
                ...
                <div className="text-slate-900 font-light tracking-wider">
                  Lorem ipsum dolor sit amet consectetur adipisicing elit. Error earum unde excepturi facere. A atque voluptatum accusantium nostrum dignissimos. Odio temporibus facere, laborum beatae aut rerum quibusdam repellendus, veniam, dignissimos fugit eveniet nemo nobis assumenda non. Unde odio optio tempora.
                </div>
                <div className="grid grid-cols-3 gap-10">
                  <div className="col-span-1 flex items-center gap-5">
                    ...
                    />
                    <span className="capitalize font-medium text-slate-900">fishing</span>
                  </div>
                  <div className="col-span-1 flex items-center gap-5">
                    <Image
                      alt="Icon"
                    ...
                    />
                    <span className="capitalize font-medium text-slate-900">spa</span>
                  </div>
                  <div className="col-span-1 flex items-center gap-5">
                    <Image
                      alt="Icon"
                    ...
                    />
                    <span className="capitalize font-medium text-slate-900">bar</span>
                  </div>
                  <div className="col-span-1 flex items-center gap-5">
                    <Image
                      alt="Icon"
                    ...
                    />
                    <span className="capitalize font-medium text-slate-900">barbeque</span>
                  </div>
                  <div className="col-span-1 flex items-center gap-5">
                    <Image
                      alt="Icon"
                    ...
                    />
                    <span className="capitalize font-medium text-slate-900">dining</span>
                  </div>
                  <div className="col-span-1 flex items-center gap-5">
                    <Image
                      alt="Icon"
                    ...
                    />
                    <span className="capitalize font-medium text-slate-900">pool</span>
                  </div>
                </div>
                <div className="pt-10">
                  <Link href="" className="m-0 block">
                    <span className="text-black capitalize px-7 py-3 rounded-full border-slate-900 border">view all offers</span>
                  </Link>
                </div>
              </div>
            </div>
        ...
        <div className="container">
          <div className="space-y-10">
            ...
            <div className="grid grid-cols-4 place-items-center gap-10">
              <div className="col-span-4 text-center md:text-left md:col-span-2 lg:col-span-1">
                <div className="font-bold text-5xl capitalize text-black">25k</div>
                <div className="text-sm uppercase font-light text-slate-900 tracking-widest">
                  happy clients
                </div>
              </div>
              <div className="col-span-4 text-center md:text-left md:col-span-2 lg:col-span-1">
                <div className="font-bold text-5xl capitalize text-black">160</div>
                <div className="text-sm uppercase font-light text-slate-900 tracking-widest">
                  total rooms
                </div>
              </div>
              <div className="col-span-4 text-center md:text-left md:col-span-2 lg:col-span-1">
                <div className="font-bold text-5xl capitalize text-black">28</div>
                <div className="text-sm uppercase font-light text-slate-900 tracking-widest">
                  awards won
                </div>
              </div>
              <div className="col-span-4 text-center md:text-left md:col-span-2 lg:col-span-1">
                <div className="font-bold text-5xl capitalize text-black">100</div>
                <div className="text-sm uppercase font-light text-slate-900 tracking-widest">
                  team members
                </div>
              </div>
        ...
        <div className="container">
          <div className="flex items-center justify-center">
            <div className="max-w-[600px]">
              <div className="space-y-7">
                <div className="text-slate-900 text-lg text-center font-light tracking-wider">
                  Lorem ipsum dolor sit amet consectetur adipisicing elit. Error earum unde excepturi facere. A atque voluptatum accusantium nostrum dignissimos. Odio temporibus facere, laborum beatae aut rerum quibusdam repellendus, veniam, dignissimos fugit eveniet nemo nobis assumenda non. Unde odio optio tempora.
                </div>
              ...
              <div className="space-y-7">
                ...
                <div className="space-y-3">
                  ...
                  <div>
                    ...
                    <Link href="">
                      <span className="hover:underline">+31 939 7777</span>
                    </Link>
                    &#44;&nbsp;
                    <Link href="">
                      <span className="hover:underline">+31 454 6233</span>
                    </Link>
                  </div>
                  <div>
                    <span className="font-semibold capitalize">email: </span>
                    <Link href="mailto://info@myhotelwebsite.com">
                      <span className="hover:underline">info@myhotelwebsite.com</span>
                    </Link>
                  </div>
                </div>
                <div className="pt-5">
                  <Link href="/contact-us" className="m-0 block">
                    <span className="text-white capitalize bg-slate-900 px-7 py-3 rounded-full border-slate-900 border">send a message</span>
                  </Link>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-10">
              ...
              <div className="flex gap-3 p-1 border-2 rounded-full border-black">
                <input
                  ...
                  className="py-2 px-3 text-lg outline-none border-none rounded-full block w-full flex-1"
                />
                <input
                  type="submit"
                  value="subscribe"
                  className="rounded-full tracking-wider px-7 py-2 bg-black text-white capitalize"
                />
              </div>
            </div>
          </div>
